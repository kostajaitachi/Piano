...
VoicForm voice1 => JCRev reverb => Pan2 master => dac;
...
[/*0*/[  0. , .0000 , .0504 , .9037 , 5.5909 , .2094 , .8   , .2],
 ...
 /*6*/[ 16. , .0000 , .6125 , .3521 , 5.6098 , .0167 , .8   , .2],
 /*7*/[ 16. , .0000 , .6003 , .4726 , 6.7799 , .1393 , .8   , .2],
 /*8*/[ 17. , .0000 , .9703 , .1151 , 9.0939 , .0850 , .8   , .2],
 /*9*/[ 19. , .0000 , .9999 , .9139 , 9.0046 , .0186 , .8   , .2]]
   @=> float presets[][];
